...
import green from "../assets/yes.svg";
import red from "../assets/no.svg";
  ...
  const packages = [
    {
      ...
      yearlyPrice: 199,
      description:
        "A common form of Lorem ipsum reads: Loreum ipsum dolor sit met, consectetur adipiscing elit.",
    },
    {
      name: "Advance",
      monthlyPrice: 39,
          ...
          >
            ...
            <ul className="mt-4 space-y-2 px-4">
              <li className="flex gap-2 items-center">
                <img src={green} className="w-4 h-4" />
                Videos of lessons
              </li>
              <li className="flex gap-2 items-center">
                <img src={green} className="w-4 h-4" />
            ...
            <div className="w-full mx-auto mt-8 flex items-center justify-center">
              <button className="btnPrimary">Get Start</button>
            </div>
          </div>
        ))}
      </motion.div>
